  ...
  return (
    <div className={styles.app}>
      <div className={styles.playerWrapper}>
        <Header>
          正在播放：<span className={styles.curAudioName}>{curtAudio.name}</span>
      ...
      <div className={styles.playListWrapper}>
        <Header>播放列表</Header>
        <PlayList playList={playList} playItem={curtAudio} onUpload={onUpload} setPlayItem={clickPlayItem} />
      </div>
    </div>
  )
}
